...
export const networks = {
  testnet: {
    ...
    contractId: "CDGL73SOPVKDAH6JTRTRAIJZTW5EBSTYFYNLGJS7SOYPM2XTFJPOY2WY",
  }
} as const

export type DataKey = {tag: "Deadline", values: void} | {tag: "Recipient", values: void} | {tag: "Started", values: void} | {tag: "Target", values: void} | {tag: "Token", values: void} | {tag: "User", values: readonly [string]} | {tag: "RecipientClaimed", values: void};
...
export interface Client {
   ...
   */
  initialize: ({recipient, deadline, target_amount, token}: {recipient: string, deadline: u64, target_amount: i128, token: string}, options?: {
    /**
  ...
  /**
   * Construct and simulate a started transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  started: (options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
...
export class Client extends ContractClient {
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAABwAAAAAAAAAAAAAACERlYWRsaW5lAAAAAAAAAAAAAAAJUmVjaXBpZW50AAAAAAAAAAAAAAAAAAAHU3RhcnRlZAAAAAAAAAAAAAAAAAZUYXJnZXQAAAAAAAAAAAAAAAAABVRva2VuAAAAAAAAAQAAAAAAAAAEVXNlcgAAAAEAAAATAAAAAAAAAAAAAAAQUmVjaXBpZW50Q2xhaW1lZA==",
        "AAAAAAAAAAAAAAAKaW5pdGlhbGl6ZQAAAAAABAAAAAAAAAAJcmVjaXBpZW50AAAAAAAAEwAAAAAAAAAIZGVhZGxpbmUAAAAGAAAAAAAAAA10YXJnZXRfYW1vdW50AAAAAAAACwAAAAAAAAAFdG9rZW4AAAAAAAATAAAAAA==",
        "AAAAAAAAAAAAAAAJcmVjaXBpZW50AAAAAAAAAAAAAAEAAAAT",
        "AAAAAAAAAAAAAAAIZGVhZGxpbmUAAAAAAAAAAQAAAAY=",
        "AAAAAAAAAAAAAAAHc3RhcnRlZAAAAAAAAAAAAQAAAAY=",
        "AAAAAAAAAAAAAAAFc3RhdGUAAAAAAAAAAAAAAQAAAAQ=",
        "AAAAAAAAAAAAAAAGdGFyZ2V0AAAAAAAAAAAAAQAAAAs=",
        ...
        "AAAAAAAAAAAAAAAId2l0aGRyYXcAAAABAAAAAAAAAAJ0bwAAAAAAEwAAAAA=" ]),
      options
    )
  }
  public readonly fromJSON = {
    initialize: this.txFromJSON<null>,
        recipient: this.txFromJSON<string>,
        deadline: this.txFromJSON<u64>,
        started: this.txFromJSON<u64>,
        state: this.txFromJSON<u32>,
        target: this.txFromJSON<i128>,
